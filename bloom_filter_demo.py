                ...
                for line in file:
                    ...
                    if address and address.startswith('1'):  # Only process P2PKH addresses
                        ...
                        if total_addresses % 1000000 == 0:
                            print(f"Processed {total_addresses} addresses so far...")
...
def compare_with_set(bloom_filter, num_lookups=1000000):
    ...
    # Create a set with the same random data
    import random
    import string
...
if __name__ == "__main__":
    ...
    bloom_filter, total_addresses = load_database_with_bloom_filter()
    
    # Benchmark Bloom filter performance
    benchmark_bloom_filter(bloom_filter)
    
    # Compare with Python set
    compare_with_set(bloom_filter)
